...
MainWindow::MainWindow(QWidget *parent)
    ...
    createRecordButton = new QPushButton("Создать новую запись");
    deleteRecordButton = new QPushButton("Удалить запись");

    contentButtonsControlGroup = new QGroupBox("Панель редактирования");
